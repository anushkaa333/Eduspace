...
<body>
	<table class="tstyle" border=all>
		...
		<?php
		$tid = $_SESSION['tid'];
    $q='select course.cname , student.sname from student, course ,teacher,apply where student.sid=apply.sid and course.cid=apply.cid and teacher.tid=course.tid and teacher.tid='.$tid;
  ...
  <div class="container-fluid" style="width:100%; height:30px; background-color:black; margin-top: 30%; ">
