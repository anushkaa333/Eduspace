...
:placeholder-shown{
  ...
  <body>
    ...
    <div class="form">
      <form class="login-form" action="t_validation.php" method="post" style="background-color:white;">
      ...
      <form class="signup-form" action="t_regis.php" method="post" style="background-color:white;">
      <div class="login" style="width:330px; height:60px;  background-color: #225470; padding:10px;">
       ...
       <input class="user-input" type="text" name="user" placeholder="Username*" required style="border:1px solid #ececec; width:300px; background:#ececec; border-radius:20px;">
         ...
         <input class="user-input" type="text" name="desig" placeholder="Desination*" required style="border:1px solid #ececec; width:300px; background:#ececec; border-radius:20px;">
          <input class="user-input" type="password" name="password" placeholder="Password*" required style="border:1px solid #ececec; width:300px; background:#ececec; border-radius:20px;">
           ...
           <input class="user-input" type="text" name="tname" placeholder="Student name*" required style="border:1px solid #ececec; width:300px; background:#ececec; border-radius:20px;">
